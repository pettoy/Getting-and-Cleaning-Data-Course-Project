...
write.csv(dat1, file = "C:/Users/Peter/DataScience/Getting-and-Cleaning-Data-Course/TidyHumanActivityDataset.csv", 
          row.names = FALSE)


write.csv(dat2, file = "C:/Users/Peter/DataScience/Getting-and-Cleaning-Data-Course/HumanActivitySummaryData.csv", 
          row.names = FALSE)
